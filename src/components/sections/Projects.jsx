        ...
        <section id="projects" className="min-h-screen flex items-center justify-center py-20">
            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                {projectItems.map((project, key) => (
                    <div key={key} className="relative border border-white/10 rounded-xl p-6 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)">
                        ...
                        <a href={project.url} className="absolute bottom-4 right-6" ><FontAwesomeIcon icon={faGithub} /></a>
                    </div>
                ))}
            </div>
            </div>
