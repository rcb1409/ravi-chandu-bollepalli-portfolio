export const MobileMenu = ({menuOpen, setMenuOpen}) => {
    ...
    return(
        <div className={`z-40 fixed top-0 left-0 w-full  bg-[rgba(10,10,10,0.8)] flex flex-col items-center justify-center transition-all duration-300 ease-in-out ${menuOpen ? "h-screen opacity-100 pointer-events-auto" : "h-0 opacity-0 pointer-events-none"}`}>
            <button onClick={() => {setMenuOpen(false)}} className="absolute top-6 right-6 cursor-pointer text-3xl">
                &times;
            </button>
